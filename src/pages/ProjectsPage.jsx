...
export default function ProjectsPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900">
      ...
      <main className="container mx-auto px-4 md:px-6 py-20 md:py-32">
        {/* Header */}
        <motion.div
        ...
        >
          <DecryptedText
            ...
            parentClassName="block mb-4 md:mb-6"
          />
          ...
          <Link
            to="/"
            className="inline-flex items-center space-x-2 text-accent-blue hover:text-accent-blue-light transition-colors mt-6 text-sm md:text-base"
          >
        ...
        >
          {categories.map((category) => (
            <button
              ...
              className={`px-4 md:px-6 py-2 md:py-3 rounded-lg font-medium transition-all duration-300 text-sm md:text-base focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 focus:ring-offset-gray-900 ${
                filter === category
                ...
                <div className="relative p-5 md:p-6 flex-1 flex flex-col">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.map((tag, tagIndex) => (
                      <span
                        key={tagIndex}
                        className="px-2.5 py-1 text-xs bg-white/10 rounded-full text-gray-300"
                      >
                        {tag}
                      </span>
                    ))}
                  ...
                  {/* View Project Link */}
                  <span className="inline-flex items-center space-x-2 text-accent-blue group-hover:text-accent-blue-light transition-colors duration-300 text-sm md:text-base">
        ...
        >
          <p className="text-gray-400 mb-4 text-sm md:text-base">Want to see more?</p>
          <a
            href="https://github.com/Harold-Odro"
            target="_blank"
            rel="noopener noreferrer"
            className="group inline-flex items-center space-x-2 px-6 md:px-8 py-3 md:py-4 bg-white/10 backdrop-blur-sm rounded-lg hover:bg-white/20 transition-all duration-300 text-sm md:text-base"
          >
